...
const AFFILIATE_PRODUCTS = {
  ...
  "shade-netting":   { name:"Garden Shade Netting", why:"Protects crops from scorching during heatwaves — reduces leaf scorch and bolting", url:"https://amzn.to/4w37Rju", tag:"🌡️ Protection" },
  "soaker-hose":     { name:"Soaker Hose", why:"Delivers water directly to roots — perfect for heatwaves and water efficiency", url:"https://amzn.to/3ONq8kd", tag:"🌡️ Protection" },
  // ── SOIL & COMPOST ──
      ...
      <div style={{ minHeight:"100vh" }}>
        ...
        <div style={{ padding:"14px", display:"flex", flexDirection:"column", gap:11 }}>
          ...
          {p.products && p.products.length > 0 && (() => {
            const prods = p.products.map(k => AFFILIATE_PRODUCTS[k]).filter(Boolean);
