...
const AFFILIATE_PRODUCTS = {
  ...
  "watering-can":    { name:"10L Watering Can with Rose", why:"A long-reach rose gives the gentle shower seeds need", url:"https://amzn.to/4udFugW", tag:"🪴 Equipment" },
  ...
  // ── PROTECTION ──
  "fleece":          { name:"Horticultural Fleece Roll", why:"Essential for frost protection — keep a roll handy March to June", url:"https://amzn.to/3QkNSwz", tag:"🌡 Protection" },
  "cloche":          { name:"Polypropylene Cloches", why:"Warms soil and protects early crops — extends season by weeks", url:"https://amzn.to/4u4pkGm", tag:"🌡 Protection" },
  "shade-netting":   { name:"Garden Shade Netting", why:"Protects crops from scorching during heatwaves — reduces leaf scorch and bolting", url:"https://amzn.to/4w37Rju", tag:"🌡 Protection" },
  "soaker-hose":     { name:"Soaker Hose", why:"Delivers water directly to roots — perfect for heatwaves and water efficiency", url:"https://amzn.to/3ONq8kd", tag:"🌡 Protection" },
  // ── SOIL & COMPOST ──
  "compost-bin":     { name:"300L Compost Bin", why:"Every plot needs at least one — free compost from kitchen and garden waste", url:"https://amzn.to/3QkO3YL", tag:"♻ Soil" },
  "ph-tester":       { name:"Soil pH Test Kit", why:"Know your soil — vegetables prefer pH 6.0–7.0", url:"https://amzn.to/3OBONbo", tag:"♻ Soil" },
  "growmore":        { name:"Blood Fish & Bone Fertiliser", why:"A balanced organic feed to work into beds before planting", url:"https://amzn.to/4mTqZMY", tag:"♻ Soil" },
};
...
const BADGES = [
  ...
  { id:"sun-chaser",       e:"☀", t:"Sun Chaser",         d:"Completed sunlight & watering",         cat:"learning" },
  ...
  { id:"all-seasons",      e:"🗓", t:"All Seasons",        d:"Completed Level 4",                     cat:"level" },
...
const COURSES = [
  {
    ...
    lessons:[
      ...
      {
        id:"l1-sunlight", title:"Sunlight & Watering", emoji:"☀", dur:"6 min", vk:"sunlight-watering",
        xp: 20,
  ...
  {
    id:"level-4", level:4, title:"Grow All Year", emoji:"🗓", color:"#1565C0",
    ...
    lessons:[
      ...
      {
        id:"l4-winter", title:"Winter Growing", emoji:"❄", dur:"9 min", vk:"winter-growing", xp:25,
  ...
  },
  {
    ...
    lessons:[
      {
        id:"l5-plot-planning", title:"Planning Your Plot Layout", emoji:"🗺", dur:"10 min", vk:"plot-planning", xp:30,
      ...
      {
        id:"l5-composting", title:"Composting Masterclass", emoji:"♻", dur:"10 min", vk:"composting", xp:30,
      ...
      {
        id:"l5-no-dig", title:"No-Dig Growing", emoji:"⛏", dur:"9 min", vk:"no-dig", xp:30,
  ...
  },
  {
    ...
    lessons:[
      ...
      {
        id:"l6-chillies-peppers", title:"Chillies & Peppers", emoji:"🌶", dur:"11 min", vk:null, xp:40,
...
const MONTHLY = {
  1:{s:["Onion seeds (indoors)","Broad beans (indoors)","Chillies (heated propagator)"],po:[],h:["Winter salad leaves","Kale","Leeks"],j:["Order seeds from catalogues","Plan your growing space","Clean and sharpen tools","Start chitting seed potatoes"],tip:"🌨 January is perfect for planning. Best varieties sell out quickly — order seeds now!"},
  2:{s:["Broad beans","Onions","Aubergines (heated)","Chillies"],po:[],h:["Purple sprouting broccoli","Winter salads","Kale"],j:["Continue chitting potatoes","Prepare beds with compost","Sow indoors with heat","Check for early slugs"],tip:"❄ Still cold but indoors we can get started! Windowsills and heat mats are your friends."},
...
const PROBLEMS = [
  ...
  {id:"heatwave",title:"Heatwave Stress",emoji:"🌡",sev:"high",vk:"heatwave",products:["shade-netting","soaker-hose","watering-can"],looks:"Leaves wilting or scorching even after watering. Flowers dropping before setting fruit. Lettuce and spinach bolting suddenly. Soil drying out within hours of watering.",causes:["Prolonged temperatures above 28°C stressing plants","Direct midday sun scorching leaves","Roots overheating in containers and raised beds","Bolting triggered by heat and long days in salad crops"],fix:"Shade vulnerable crops with netting or fleece during the hottest part of the day (11am–3pm). Water deeply in the early morning before heat builds — never in midday sun. Mulch thickly around plants to lock in moisture. Move containers into shade temporarily. Pick salad crops before they bolt.",prev:"Choose heat-tolerant varieties where possible. Install shade netting before a heatwave arrives — not during it. Mulch beds early in the season. Group containers together so they shade each other's roots."},
];
      ...
      <div style={{ padding:"20px 18px", flex:1 }}>
        ...
        <div className="card" style={{ marginBottom:12, border:"2px solid var(--g2)" }}>
          <div style={{ display:"flex", gap:12, alignItems:"flex-start" }}>
            <div style={{ width:44, height:44, background:"var(--g6)", borderRadius:12, display:"flex", alignItems:"center", justifyContent:"center", fontSize:18, flexShrink:0 }}>🗺</div>
            <div>
  ...
  return (
    <div>
      ...
      <div style={{ padding:"16px", display:"flex", flexDirection:"column", gap:14 }}>
        {/* Streak warning */}
        {/* Next lesson card */}
        {nextLesson && <button onClick={() => navigate("lesson", { course: nextLesson.c, lesson: nextLesson.l })} style={{ width:"100%", background:"linear-gradient(135deg,#E8F5E9,#F1F8E9)", border:"2px solid #A5D6A7", borderRadius:16, padding:"14px 16px", display:"flex", gap:12, alignItems:"center", cursor:"pointer", fontFamily:"var(--ff)", textAlign:"left" }}>
          <div style={{ fontSize:28, flexShrink:0 }}>{nextLesson.l.emoji}</div>
          <div style={{ flex:1 }}>
            <div style={{ color:"#2E7D32", fontWeight:800, fontSize:12, marginBottom:2 }}>📚 Continue Learning</div>
            <div style={{ color:"var(--td)", fontWeight:700, fontSize:14, marginBottom:1 }}>{nextLesson.l.title}</div>
            <div style={{ color:"var(--tl)", fontSize:11 }}>{nextLesson.c.title} · {nextLesson.l.dur}</div>
          </div>
          <div style={{ color:"#4CAF50", fontSize:18 }}>→</div>
        </button>}
        ...
        <div style={{ background:"linear-gradient(135deg,#1a1a2e,#16213e)", borderRadius:20, overflow:"hidden" }}>
          ...
          <div style={{ padding:"16px 18px 18px" }}>
            ...
            <p style={{ color:"rgba(255,255,255,.65)", fontSize:13, lineHeight:1.6, marginBottom:14 }}>
              Glen's month-by-month growing planner — what to sow, plant and harvest every week of the year. Worth £5 — yours <strong style={{ color:"#FFD700" }}>completely free</strong> when you unlock premium levels.
            </p>
            ...
            <div style={{ background:"linear-gradient(135deg,#1a0a00,#3E1F00)", border:"2px solid #FF8F0044", borderRadius:22, padding:18, overflow:"hidden", position:"relative" }}>
              ...
              <div style={{ background:"rgba(255,255,255,.05)", border:"1px solid rgba(255,143,0,.3)", borderRadius:16, padding:"18px" }}>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:9, marginBottom:16 }}>
                  {[
                    ["🗓","Grow All Year Round","Never have a bare plot again — plan across all four seasons"],
      ...
      <div style={{ padding:"14px 16px", display:"flex", flexDirection:"column", gap:14 }}>
        ...
        <div className="card">
          ...
          {lesson.mistakes && <div style={{ background:"#FFF3E0", border:"1px solid #FFCC80", borderRadius:12, padding:"12px 14px", marginTop:8 }}>
            <div style={{ fontWeight:800, fontSize:13, color:"#E65100", marginBottom:6 }}>⚠ Common mistakes</div>
        ...
        {isQuizDone && (() => {
          ...
          return (
            <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
              ...
              {nextLesson && <button onClick={() => navigate("lesson", { course, lesson: nextLesson })} style={{ width:"100%", background:"linear-gradient(135deg,#E8F5E9,#F1F8E9)", border:"2px solid #A5D6A7", borderRadius:16, padding:"14px 16px", display:"flex", gap:12, alignItems:"center", cursor:"pointer", fontFamily:"var(--ff)", textAlign:"left" }}>
                <div style={{ fontSize:24, flexShrink:0 }}>{nextLesson.emoji}</div>
                <div style={{ flex:1 }}>
                  <div style={{ color:"#2E7D32", fontWeight:800, fontSize:11, marginBottom:2 }}>▶ Next Lesson</div>
                  <div style={{ color:"var(--td)", fontWeight:700, fontSize:13 }}>{nextLesson.title}</div>
                </div>
                <div style={{ color:"#4CAF50", fontSize:18 }}>→</div>
              </button>}
            </div>
        ...
        <div style={{ marginBottom:14, padding:"10px 14px", background:"rgba(255,255,255,.6)", borderRadius:12 }}>
          <div style={{ display:"flex", justifyContent:"center", gap:6, marginBottom:4 }}>
            {Array.from({length:5}).map((_,i) => (
              <span key={i} style={{ fontSize:20 }}>{i < (5 - heartsLost) ? "❤" : "🤍"}</span>
            ))}
          </div>
...
function VideosPage() {
  ...
  const sections = [
    ...
    {title:"🗓 Level 4: Grow All Year",keys:["seasonal-planning","winter-growing","succession-sowing","green-manures"]},
...
function PlannerPage() {
  ...
  const MONTHS = [
    {name:"January",emoji:"❄",sow:["Chillies","Peppers (heated propagator)"],plant:[],harvest:["Parsnips","Leeks","Kale"],jobs:["Order seeds early — best varieties sell out","Plan your crop rotation for the year","Check stored vegetables"]},
    ...
    {name:"May",emoji:"☀",sow:["More beans","Succession lettuce","Carrots"],plant:["Tomatoes (after mid-May)","Courgettes","Cucumbers","Squash"],harvest:["Asparagus","Radishes","Lettuce","Spring onions"],jobs:["Last frost date usually mid-May","Pinch out tomato sideshoots","Start watering regularly"]},
    ...
    {name:"November",emoji:"🌧",sow:[],plant:[],harvest:["Parsnips","Leeks","Kale","Brussels sprouts","Carrots"],jobs:["Protect brassicas from pigeons","Mulch beds to protect roots","Plan next year"]},
  ...
  return (
    <div style={{ minHeight:"100vh" }}>
      ...
      <div style={{ padding:"16px", display:"flex", flexDirection:"column", gap:14 }}>
        ...
        {/* Diary upsell */}
        <div style={{ background:"linear-gradient(135deg,#1a1a2e,#16213e)", borderRadius:20, overflow:"hidden" }}>
          <img src="data:image/png;base64," alt="Garden Planner Diary" style={{ width:"100%", display:"block" }} onError={e => e.target.style.display="none"}/>
    ...
    return (
      <div style={{ minHeight:"100vh" }}>
        ...
        <div style={{ padding:"14px", display:"flex", flexDirection:"column", gap:11 }}>
          ...
          <div className="tip"><h2 style={{ fontSize:13, fontWeight:800, marginBottom:5, color:"var(--g8)" }}>🛡 Prevention</h2><p style={{ fontSize:13, color:"var(--tm)", lineHeight:1.6 }}>{p.prev}</p></div>
          {p.products && p.products.map(k => AFFILIATE_PRODUCTS[k]).filter(Boolean).length > 0 && <div className="card">
            <h2 style={{ fontSize:13, fontWeight:800, marginBottom:4, color:"var(--td)" }}>🛒 Recommended kit</h2>
            <p style={{ fontSize:11, color:"var(--tl)", marginBottom:12 }}>Handpicked by Glen · Affiliate links help support this free app · Opens in Amazon</p>
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              {p.products.map(k => AFFILIATE_PRODUCTS[k]).filter(Boolean).map((prod,i) => (
                <a key={i} href={prod.url} target="_blank" rel="noopener noreferrer"
                  style={{ display:"flex", gap:12, alignItems:"center", background:"var(--cream)", borderRadius:12, padding:"11px 13px", textDecoration:"none", border:"1px solid var(--cdk)" }}>
                  <span style={{ fontSize:24, flexShrink:0 }}>📦</span>
                  <div style={{ flex:1, minWidth:0 }}>
                    <div style={{ fontWeight:700, fontSize:13, color:"var(--td)", marginBottom:2 }}>{prod.name}</div>
                    <div style={{ fontSize:11, color:"var(--tl)", lineHeight:1.4 }}>{prod.why}</div>
                    <div style={{ fontSize:10, color:"var(--g5)", fontWeight:700, marginTop:3 }}>{prod.tag}</div>
                  </div>
                  <span style={{ fontSize:11, color:"var(--g5)", fontWeight:700, flexShrink:0 }}>View on Amazon →</span>
                </a>
              ))}
            </div>
          </div>}
  ...
  return (
    <div style={{ minHeight:"100vh" }}>
      ...
      <div style={{ padding:"14px 16px", display:"flex", flexDirection:"column", gap:12 }}>
        ...
        {aiError && !aiLoading && <div style={{ background:"#FFF3E0", border:"1px solid #FFB74D", borderRadius:14, padding:"14px 16px" }}><div style={{ fontWeight:800, fontSize:13, color:"#E65100" }}>⚠ Couldn't get an answer right now</div></div>}
        {!aiAnswer && !aiLoading && <>
    ...
    <div style={{ minHeight:"100vh", background:"var(--cream)", paddingBottom:100 }}>
      ...
      <div style={{ padding:"16px 18px", display:"flex", flexDirection:"column", gap:14 }}>
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", background:"var(--g0)", border:"1px solid var(--g2)", borderRadius:14, padding:"12px 16px" }}>
          <div style={{ display:"flex", alignItems:"center", gap:8 }}><span style={{ fontSize:18 }}>{darkMode?"🌙":"☀"}</span><span style={{ fontSize:13, fontWeight:700 }}>Dark Mode</span></div>
...
function LevelCompletePage() {
  ...
  const LEVEL_MSGS = {
    ...
    "level-4":{msg:"You think like a real grower now. Planning, succession, soil care — all mastered.",emoji:"🗓"},
  ...
  const LEVEL_DANCERS = {"level-1":["🌱","🌿","🫘"],"level-2":["🥬","🥕","🌿"],"level-3":["🍅","🥔","🥒"],"level-4":["🗓","❄","🔄"],"level-5":["🏡","♻","💧"],"level-6":["👨‍🌾","🌟","🏆"]};
        ...
        {success ? (
          ...
          <>
            ...
            <div className="card">
              ...
              {[
                ["🗓","Level 4 — Grow All Year Round","4 lessons"],
...
function Router() {
  ...
  return (
    <div className="wrap" style={{ background: darkMode ? "#0f1a0a" : "transparent" }}>
